...
class User extends ActiveRecord implements IdentityInterface {
	...
	public static function statuses() {
		return [
			self::STATUS_NOT_ACTIVE => Yii::t('common', 'Неактивно'),
			self::STATUS_ACTIVE => Yii::t('common', 'Активно'),
			self::STATUS_DELETED => Yii::t('common', 'Удалено')
		];
	}
	...
	public function attributeLabels() {
		return [
			...
			'access_token' => Yii::t('common', 'Токен доступа к API'),
			'created_at' => Yii::t('common', 'Создано'),
			'updated_at' => Yii::t('common', 'Последнее обновление'),
			'logged_at' => Yii::t('common', 'Последний вход'),
			'site_id' => "Текущий проект",
		];
	}
