...
<a onclick="$('.block-4-upload-form').show(100);$(this).hide();$('.hide-btn-4').show()" class="add-btn-4">обновить фото</a>
...
<div class="result">
	...
	<img src="<?= $obj->data["file"] ?>" class="rounded ava"> <br>
	<input class="input-text-edit" type="text" name="DATA[name]" value="<?= $obj->data["name"] ?>" placeholde="Ваш ник или имя" >
    </div>
</div>