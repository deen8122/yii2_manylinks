    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
                <span class="sr-only"><?php echo Yii::t('backend', 'Навигация') ?></span>
		    ...
		    <?if(count(Yii::$app->user->identity->sites)>0):?>
		    <li id="timeline-notifications" class="notifications-menu">
                        <a title="Сайты" href="<?php echo Url::to(['/sign-in/sites']) ?>">
		    ...
		    <?endif?>
				...
				<?php echo SystemLog::find()->count() ?>
				    ...
				    <?php endforeach; ?>
                            ...
                            <li class="footer">
				<?php echo Html::a(Yii::t('backend', 'Смотреть всё'), ['/system/log/index']) ?>
                            </li>
                        </ul>
                    </li>
					...
					<?php echo Yii::t('backend', 'Участник с {0, date, short}', Yii::$app->user->identity->created_at) ?>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
				    <?php echo Html::a(Yii::t('backend', 'Профиль'), ['/sign-in/profile'], ['class' => 'btn btn-default btn-flat']) ?>
                                </div>
                                <div class="pull-left">
				    <?php echo Html::a(Yii::t('backend', 'Аккаунт'), ['/sign-in/account'], ['class' => 'btn btn-default btn-flat']) ?>
                                </div>
    ...
    <aside class="main-sidebar">
	    ...
	    echo Menu::widget([
		    ...
		    'items' => [
			    ...
			    [
				    'label' => Yii::t('backend', 'Главный модуль'),
			    ...
			    [
				    'label' => Yii::t('backend', 'Организации'),
				    'icon' => '<i class="fa fa-bars"></i>',
				    'url' => ['/siteconfig/index'],
				    'badgeBgClass' => 'label-success',
				    'visible' => Yii::$app->user->can('administrator'),
			    ],
			    [
				    'label' => Yii::t('backend', 'Структуа организации'),
				    'icon' => '<i class="fa fa-bars"></i>',
				    'url' => ['/orgstructure/index'],
				    'badgeBgClass' => 'label-success',
				    'visible' => Yii::$app->user->can('administrator'),
			    ],
			    
			    [
				    'label' => Yii::t('backend', 'Услуги'),
				    'options' => ['class' => 'header'],
			    ],
			    [
				    'label' => Yii::t('backend', 'Категории услуг'),
				    'icon' => '<i class="fa fa-list-alt"></i>',
				    'url' => ['/timereservation/category/index'],
				    'badgeBgClass' => 'label-success',
			    ],
			    [
				    'label' => Yii::t('backend', 'Список услуг'),
				    'icon' => '<i class="fa fa-list"></i>',
				    'url' => ['/timereservation/service/index'],
				    'badgeBgClass' => 'label-success',
			    ],
			    [
				    'label' => Yii::t('backend', 'Календарь'),
				    'icon' => '<i class="fa fa-calendar"></i>',
				    'url' => ['/timereservation/calendar/index'],
				    'badgeBgClass' => 'label-success',
			    ],
			    [
				    'label' => Yii::t('backend', 'Настройки'),
				    'icon' => '<i class="fa fa-wrench"></i>',
				    'url' => ['/timereservation/setting/index'],
				    'badgeBgClass' => 'label-success',
			    ],
			    
			    /*
			    [
				    'label' => Yii::t('backend', 'Задачи'),
				    'options' => ['class' => 'header'],
			    ],
			    [
				    'label' => Yii::t('backend', 'Задачи'),
			    ...
			    [
				    'label' => Yii::t('backend', 'Отклики'),
				    'icon' => '<i class="fa fa-bars"></i>',
				    'url' => ['/task-message/index'],
				    'badgeBgClass' => 'label-success',
			    ],
			     * 
			     */
			    ...
			    [
				    'label' => Yii::t('backend', 'Статические страницы'),
			    ...
			    [
				    ...
				    'items' => [
					    [
						    'label' => Yii::t('backend', 'Текстовые блоки'),
			    ...
			    [
				    'label' => Yii::t('backend', 'Информация о системе'),
				    'url' => ['/system/information/index'],
				    'icon' => '<i class="fa fa-dashboard"></i>',
			    ],
			    [
				    'label' => Yii::t('backend', 'Журнал'),
